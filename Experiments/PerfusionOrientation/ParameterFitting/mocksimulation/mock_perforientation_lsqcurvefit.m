...
CA0 =   6.3256;  iBVF0 = 1.1738/100; aBVF0 = 1.2852/100;
...
% alpha_range = 17.5:10.0:87.5;
% alpha_range = 17.5:5.0:87.5;
alpha_range = [17.5, 47.5, 87.5];
...
optfun = @(x,xdata) perforientation_lsqoptfun(x, xdata, ...
    ...
    Navgs, type, order, SaveFigs, SaveIterResults, DiaryFilename);
