...
% Account for effective vessel angle in the presence of branching
if args.EffectiveVesselAngles
    AlphaRange = Geometry.VesselAngleDistribution.vessel_angle_distribution(AlphaRange);
end
