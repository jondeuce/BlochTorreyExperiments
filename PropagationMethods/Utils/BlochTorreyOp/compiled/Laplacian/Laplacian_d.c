 ...
 *
 * INPUT ARGUMENTS
 *  prhs[0] -> x:     input array (3D real REAL array)
...
void Laplacian3D( REAL *dxr, const REAL *xr, const REAL K, const REAL *gsize );
void Laplacian4D( REAL *dxr, const REAL *xr, const REAL K, const REAL *gsize );
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    void (*Laplacian)(REAL *, const REAL *, const REAL, const REAL *);
    if( ndim == 3 )
