function y = SevenPointStencilMasked(x, kern, gsize3D, iters, mask)
%SEVENPOINTSTENCILMASKED General seven point stencil operator applied to the
...
y = SevenPointStencilMasked_cd(x, kern, gsize4D, ndim, iters, mask);
