...
void SevenPointSumCplx3D(     REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumCplx4D(     REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumCplxKern3D( REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumCplxKern4D( REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumRealKern3D( REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumRealKern4D( REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumReal3D(     REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
void SevenPointSumReal4D(     REAL *dxr, REAL *dxi, const REAL *xr, const REAL *xi, const REAL *kreal, const REAL *kimag, const MTYPE *M, const REAL *gsize );
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    void (*SevenPointSum)(REAL *, REAL *, const REAL *, const REAL *, const REAL *, const REAL *, const MTYPE *, const REAL *);
    if( ndim == 3 ) {
        if( is_kern_cplx ) {
            if( is_x_cplx ) {
