 function [h,x,y,z] = Cylinder(X1,X2,r,n,cyl_color,closed,lines,alpha)
%
...
set([Cylinder;EndPlate1;EndPlate2],'FaceAlpha',alpha);

if closed==1
    h=[Cylinder;EndPlate1;EndPlate2];
else
    h=Cylinder;
end

if nargout>1;
    x=get(Cylinder,'XData');
    y=get(Cylinder,'YData');
    z=get(Cylinder,'ZData');
end