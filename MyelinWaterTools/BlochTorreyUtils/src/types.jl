...
@with_kw struct BlochTorreyParameters{T}
    ...
    R_scale::T        =    T(0.46/5.7) # ........................ [um]       Axon scale parameter for Gamma distribution (Xu et al. 2017)
    g_ratio::T        =    T(0.8370) # .......................... [unitless] TODO g-ratio (originally 0.71; 0.84658 for healthy, 0.8595 for MS)
    AxonPDensity::T   =    T(0.83) # ............................ [unitless] Axon packing density based region in white matter (Xu et al. 2017) (originally 0.83)
    MWF::T            =    T(AxonPDensity * (1 - g_ratio^2)) # .. [unitless] Myelin water fraction, assuming periodic circle packing and constant g_ratio
